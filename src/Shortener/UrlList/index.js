    ...
    return (
      <div className="link-list-container">
        <div className="link-list-header">
          <div className="link-header table-headings">LINK</div>
          <div className="visits-header table-headings">VISITS</div>
          <div className="last-visited-header table-headings">LAST VISITED</div>
        </div>

        <ul className="link-history">{this.state.linkList.reverse()}</ul>
      </div>
    );
  }
}
